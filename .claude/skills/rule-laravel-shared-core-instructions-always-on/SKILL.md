---
name: rule-laravel-shared-core-instructions-always-on
...
- Treat subagent/delegation authority and Git-isolation authority as independent. Worktrees, auxiliary checkouts/copies, `worker/*`, and `reconcile/*` are default-deny without separate human authorization explicitly naming worktrees or auxiliary checkouts; otherwise serialize writers in the principal checkout.
