---
name: rule-laravel-shared-project-mandate-always-on
...
## Notes
Reload mandate/core docs at session start; revisit roadmap and relevant module/screen docs when scope changes or at session end for updates.
