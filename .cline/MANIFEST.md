...
- `.clinerules/model-decision/shared-audit-escalation.md`
...
### Workflows
- `.clinerules/workflows/docker-audit-escalation-method.md`
...
- `.cline/skills/wf-docker-audit-escalation-method/SKILL.md`
- `.cline/skills/rule-docker-shared-audit-escalation-model-decision/SKILL.md`
