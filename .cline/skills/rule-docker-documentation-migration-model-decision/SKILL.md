...
description: "Rule: MUST use whenever the scope matches this purpose: When migrating temporary/legacy docs into Delphi templates and producing milestones/task lists."
---
