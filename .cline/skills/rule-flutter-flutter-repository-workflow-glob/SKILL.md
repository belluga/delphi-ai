...
- Run branch-delta guard when enabled by the active debt program (example: `bash ${PACED_GLOBAL_ANALYZER_PLUGIN_DIR:-tool/belluga_analysis_plugin}/bin/check_branch_delta_raw_payload_map.sh`).
