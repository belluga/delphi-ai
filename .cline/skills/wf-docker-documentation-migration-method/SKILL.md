...
description: "Workflow: MUST use whenever the scope matches this purpose: Migrate ad-hoc/temporary docs into Delphi templates with gap analysis, milestones, and team handoff."
---
