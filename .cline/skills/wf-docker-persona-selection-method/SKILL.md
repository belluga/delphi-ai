---
name: wf-docker-persona-selection-method
description: "Workflow: MUST use whenever the scope matches this purpose: Ensure every session explicitly anchors Delphi to the correct persona (Flutter engineer, Laravel engineer, DevOps, CTO/Tech Lead, etc.) so subsequent methods and language stay in sync with the project/role context."
---
