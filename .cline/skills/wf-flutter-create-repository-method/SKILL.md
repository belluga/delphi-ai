---
name: wf-flutter-create-repository-method
description: "Workflow: MUST use whenever the scope matches this purpose: Establish domain-aligned data access for Flutter features, keeping DTO knowledge in infrastructure and enforcing the architecture mandates (Section 5 Data Flow, Section 8 DI)."
---
