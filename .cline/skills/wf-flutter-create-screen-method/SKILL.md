...
description: "Workflow: MUST use whenever a Flutter screen is created; separate controller-local state, repository-owned canonical streams, and pure Screen UI."
---
