...
Before approval, resolve material implementation-horizon ambiguity in the TODO's literal section. Planning review may recommend a decision change but must not silently rewrite proposed intent.
