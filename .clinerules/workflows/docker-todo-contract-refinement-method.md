---
name: "docker-todo-contract-refinement-method"
...
<!-- Generated from `workflows/docker/todo-contract-refinement-method.md` by `tools/sync_clinerules_mirrors.py`. Do not edit directly. -->

# Workflow: TODO Contract Refinement
...
6. Build `Assumptions Preview`.
   ...
   - Separate current delivery and planned next steps from any anticipatory implementation authorized now. If none is authorized, record `none`.
