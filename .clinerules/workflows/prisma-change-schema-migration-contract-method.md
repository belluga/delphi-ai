---
name: "prisma-change-schema-migration-contract-method"
...
<!-- Generated from `workflows/prisma/change-schema-migration-contract-method.md` by `tools/sync_clinerules_mirrors.py`. Do not edit directly. -->

# Workflow: Change a Prisma Schema or Migration Contract
