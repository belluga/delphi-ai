---
name: "vite-change-build-runtime-boundary-method"
...
<!-- Generated from `workflows/vite/change-build-runtime-boundary-method.md` by `tools/sync_clinerules_mirrors.py`. Do not edit directly. -->

# Workflow: Change a Vite Build or Runtime Boundary
