...
## Purpose
Ensure the working copy is correctly wired (submodules, symlinks, permissions, README steps) before executing DevOps or CI/CD tasks. Prevent accidental dependency on boilerplate repos.
