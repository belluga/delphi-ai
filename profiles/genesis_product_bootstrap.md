...
- temporary or supporting discovery artifacts under `foundation_documentation/artifacts/**`
...
- explicit record of what was validated, what remains assumed, and what still needs follow-up
