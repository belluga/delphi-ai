---
description: Require project-owned, user-validated topology contracts before treating runtime, tenant, domain, validation target, or active-stack inferences as authoritative.
---
