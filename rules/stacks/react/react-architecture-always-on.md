---
trigger: always_on
description: Preserve explicit React component, state, effect, accessibility, and testing boundaries without activating a build tool, backend, or deployment platform.
---
