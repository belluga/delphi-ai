...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/run_lane.sh [lane] [flutter run args...]
...
Examples:
  ./scripts/run_lane.sh --flavor <flavor>
  ./scripts/run_lane.sh stage --debug --flavor <flavor>
  ./scripts/run_lane.sh main --release --flavor <flavor> -d <device-id>
