---
name: rule-docker-shared-delphi-project-setup-model-decision
description: "Rule: MUST use whenever the scope matches this purpose: When a downstream project must be onboarded, recalibrated, or rebaselined against the current Delphi AI method."
---
...
## Rationale
Delphi centralizes reusable stack and method authority. Projects should not redefine those general rules locally, but they do need calibration so available Delphi capabilities, active project topology, local specialization, and any accumulated drift are made explicit before work resumes.
