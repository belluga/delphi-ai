...
## Rationale
Session lifecycle discipline keeps context consistent across profiles, ensures instruction updates trigger session restarts, and enforces the mandated post-session review steps.
