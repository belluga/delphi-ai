...
### Gate T — Independent Test Quality Audit (required when tests changed or test confidence is material)
...
### Gate U — Independent No-Context Final Review (required for `big`; conditional for `medium/high-impact`)
