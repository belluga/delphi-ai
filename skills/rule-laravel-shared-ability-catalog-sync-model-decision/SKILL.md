---
name: rule-laravel-shared-ability-catalog-sync-model-decision
description: "Rule: MUST use whenever the scope matches this purpose: When introducing/changing Laravel abilities, keep namespace/route/policy abilities synchronized with token issuance catalogs and auth-path tests."
---
