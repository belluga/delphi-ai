---
name: rule-laravel-shared-settings-kernel-patch-contract-model-decision
description: "Rule: MUST use whenever the scope matches this purpose: When touching Settings Kernel PATCH endpoints, enforce canonical payload semantics (dot-path field presence, no envelope wrappers)."
---
