...
- For Delphi self-maintenance, require manual agnosticism review plus applicable local checks (for example `bash tools/audit_instruction_baselines.sh`) before completion.
