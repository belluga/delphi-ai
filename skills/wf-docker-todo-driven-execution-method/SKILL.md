...
description: "Workflow: MUST use whenever the scope matches this purpose: Guarantee every implementation starts from a concrete, reviewable contract (scope + DoD) and that any contextual comments are resolved before coding."
---
