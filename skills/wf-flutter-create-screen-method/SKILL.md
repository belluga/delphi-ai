---
name: wf-flutter-create-screen-method
description: "Workflow: MUST use whenever the scope matches this purpose: Scaffold a new feature screen following the Feature-First architecture with proper separation between Controller (state) and Screen (UI)."
---
