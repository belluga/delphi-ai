...
7. **Analyzer Discipline** – `fvm flutter analyze` must stay clean. Any architectural method touching Flutter code ends with an analyzer run and, when feasible, targeted unit/widget tests.
