...
- **Decision review waiver authority / reference:** `<required when Decision review status = waived; human approver/reference, otherwise n/a>`
...
- **Adherence review waiver authority / reference:** `<required when Adherence review status = waived; human approver/reference, otherwise n/a>`
