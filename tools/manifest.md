...
| `tools/todo_completion_guard.py` | python | Validate close-claim tactical TODOs in `promotion_lane/`, `completed/`, or other `Production-Ready` states before closure is trusted. |
