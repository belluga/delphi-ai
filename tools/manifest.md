...
| `tools/validate_phase_surfaces.py` | python | Validate phase-split skill groups so umbrella skills, phase skills, mirrors, workflow counterparts, `.clinerules`, and tooling-register entries stay complete. |
