...
MIRRORS: tuple[Mirror, ...] = (
    ...
    Mirror(
        key="shared-package-first",
        kind="model_decision",
        source="rules/core/package-first-model-decision.md",
        destination=".clinerules/model-decision/shared-package-first.md",
        title="Package-First Verification Gate",
    ),
    Mirror(
        key="docker-ci-pipeline",
        kind="model_decision",
        source="rules/stacks/docker/docker-ci-pipeline-model-decision.md",
        destination=".clinerules/model-decision/docker-ci-pipeline.md",
        title="Docker CI Pipeline (Model Decision)",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/docker-update-ci-pipeline.md`\n",
    ),
    Mirror(
        key="docker-runtime-ingress",
        kind="model_decision",
        source="rules/stacks/docker/docker-runtime-ingress-model-decision.md",
        destination=".clinerules/model-decision/docker-runtime-ingress.md",
        title="Docker Runtime & Ingress (Model Decision)",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/docker-update-runtime-and-ingress.md`\n",
    ),
    Mirror(
        key="docker-update-ci-pipeline",
        kind="workflow",
        source="workflows/docker/update-ci-pipeline-method.md",
        destination=".clinerules/workflows/docker-update-ci-pipeline.md",
        title="Workflow: Update CI / Pipeline",
        workflow_name="docker-update-ci-pipeline",
    ),
    Mirror(
        key="docker-update-runtime-and-ingress",
        kind="workflow",
        source="workflows/docker/update-runtime-and-ingress-method.md",
        destination=".clinerules/workflows/docker-update-runtime-and-ingress.md",
        title="Workflow: Update Runtime & Ingress",
        workflow_name="docker-update-runtime-and-ingress",
    ),
    Mirror(
        key="nestjs-architecture",
        kind="model_decision",
        source="rules/stacks/nestjs/nestjs-architecture-always-on.md",
        destination=".clinerules/model-decision/nestjs-architecture.md",
    ...
    Mirror(
        ...
        destination=".clinerules/workflows/nestjs-change-application-boundary-method.md",
        title="Workflow: Change a NestJS Application Boundary",
        workflow_name="nestjs-change-application-boundary-method",
    ),
    Mirror(
        key="react-architecture",
        kind="model_decision",
        source="rules/stacks/react/react-architecture-always-on.md",
        destination=".clinerules/model-decision/react-architecture.md",
        title="React Architecture",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/react-change-ui-boundary-method.md`\n",
    ),
    Mirror(
        key="react-change-ui-boundary-method",
        kind="workflow",
        source="workflows/react/change-ui-boundary-method.md",
        destination=".clinerules/workflows/react-change-ui-boundary-method.md",
        title="Workflow: Change a React UI Boundary",
        workflow_name="react-change-ui-boundary-method",
    ),
    Mirror(
        key="vite-build-runtime",
        kind="model_decision",
        source="rules/stacks/vite/vite-build-runtime-always-on.md",
        destination=".clinerules/model-decision/vite-build-runtime.md",
        title="Vite Build and Runtime",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/vite-change-build-runtime-boundary-method.md`\n",
    ),
    Mirror(
        key="vite-change-build-runtime-boundary-method",
        kind="workflow",
        source="workflows/vite/change-build-runtime-boundary-method.md",
        destination=".clinerules/workflows/vite-change-build-runtime-boundary-method.md",
        title="Workflow: Change a Vite Build or Runtime Boundary",
        workflow_name="vite-change-build-runtime-boundary-method",
    ),
    Mirror(
        key="postgresql-data-integrity",
        kind="model_decision",
        source="rules/stacks/postgresql/postgresql-data-integrity-always-on.md",
        destination=".clinerules/model-decision/postgresql-data-integrity.md",
        title="PostgreSQL Data Integrity",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/postgresql-change-relational-contract-method.md`\n",
    ),
    Mirror(
        key="postgresql-change-relational-contract-method",
        kind="workflow",
        source="workflows/postgresql/change-relational-contract-method.md",
        destination=".clinerules/workflows/postgresql-change-relational-contract-method.md",
        title="Workflow: Change a PostgreSQL Relational Contract",
        workflow_name="postgresql-change-relational-contract-method",
    ),
    Mirror(
        key="prisma-schema-migration",
        kind="model_decision",
        source="rules/stacks/prisma/prisma-schema-migration-always-on.md",
        destination=".clinerules/model-decision/prisma-schema-migration.md",
        title="Prisma Schema and Migration",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/prisma-change-schema-migration-contract-method.md`\n",
    ),
    Mirror(
        key="prisma-change-schema-migration-contract-method",
        kind="workflow",
        source="workflows/prisma/change-schema-migration-contract-method.md",
        destination=".clinerules/workflows/prisma-change-schema-migration-contract-method.md",
        title="Workflow: Change a Prisma Schema or Migration Contract",
        workflow_name="prisma-change-schema-migration-contract-method",
    ),
    Mirror(
        key="railway-deployment-contract",
        kind="model_decision",
        source="rules/stacks/railway/railway-deployment-contract-always-on.md",
        destination=".clinerules/model-decision/railway-deployment-contract.md",
        title="Railway Deployment Contract",
        append_text="## Workflow Reference\n\nSee: `.clinerules/workflows/railway-change-service-deployment-contract-method.md`\n",
    ),
    Mirror(
        key="railway-change-service-deployment-contract-method",
        kind="workflow",
        source="workflows/railway/change-service-deployment-contract-method.md",
        destination=".clinerules/workflows/railway-change-service-deployment-contract-method.md",
        title="Workflow: Change a Railway Service or Deployment Contract",
        workflow_name="railway-change-service-deployment-contract-method",
    ),
    Mirror(
    ...
    Mirror(
        ...
        destination=".clinerules/workflows/docker-todo-lane-framing-method.md",
        title="Workflow: TODO Lane and Framing",
        workflow_name="docker-todo-lane-framing-method",
    ),
    Mirror(
        key="docker-todo-contract-refinement-method",
        kind="workflow",
        source="workflows/docker/todo-contract-refinement-method.md",
        destination=".clinerules/workflows/docker-todo-contract-refinement-method.md",
        title="Workflow: TODO Contract Refinement",
        workflow_name="docker-todo-contract-refinement-method",
    ),
    Mirror(
        key="docker-todo-approval-gates-method",
        kind="workflow",
        source="workflows/docker/todo-approval-gates-method.md",
        destination=".clinerules/workflows/docker-todo-approval-gates-method.md",
        title="Workflow: TODO Approval Gates",
        workflow_name="docker-todo-approval-gates-method",
    ),
    Mirror(
        key="docker-todo-execution-boundary-method",
        kind="workflow",
        source="workflows/docker/todo-execution-boundary-method.md",
        destination=".clinerules/workflows/docker-todo-execution-boundary-method.md",
        title="Workflow: TODO Execution Boundary",
        workflow_name="docker-todo-execution-boundary-method",
    ),
    Mirror(
        key="docker-todo-delivery-gates-method",
        kind="workflow",
        source="workflows/docker/todo-delivery-gates-method.md",
        destination=".clinerules/workflows/docker-todo-delivery-gates-method.md",
        title="Workflow: TODO Delivery Gates",
        workflow_name="docker-todo-delivery-gates-method",
    ),
    Mirror(
        key="docker-todo-closeout-promotion-method",
        kind="workflow",
        source="workflows/docker/todo-closeout-promotion-method.md",
        destination=".clinerules/workflows/docker-todo-closeout-promotion-method.md",
        title="Workflow: TODO Closeout and Promotion",
        workflow_name="docker-todo-closeout-promotion-method",
    ),
    Mirror(
