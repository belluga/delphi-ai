...
classify_expect "$DOCKER_NORMAL" feature/docker-normal docker-normal
...
classify_expect "$DOCKER_BOT" bot/next-version docker-bot-next-version
...
classify_expect "$DOCKER_MIXED" feature/docker-mixed docker-mixed
...
classify_expect "$FLUTTER_REPO" feature/flutter flutter-only
...
classify_expect "$LARAVEL_REPO" feature/laravel laravel-only
...
classify_expect "$FLUTTER_LARAVEL" feature/flutter-laravel flutter-laravel
