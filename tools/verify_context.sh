...
check_agent_workflows "$REPO_ROOT" "../delphi-ai/methods/docker" "root .agent"
check_agent_workflows "$REPO_ROOT/flutter-app" "../../delphi-ai/methods/flutter" "flutter-app .agent"
check_agent_workflows "$REPO_ROOT/laravel-app" "../../delphi-ai/methods/laravel" "laravel-app .agent"
