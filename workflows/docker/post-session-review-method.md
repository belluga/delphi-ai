...
- Self Improvement Sessions must not modify `foundation_documentation/` during this review; any confirmed mandate changes are deferred until the instruction-only session is closed.
